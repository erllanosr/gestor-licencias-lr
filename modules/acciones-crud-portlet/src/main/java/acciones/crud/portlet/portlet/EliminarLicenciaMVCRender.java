...
@Component(immediate = true, property = { "javax.portlet.name=" + AccionesCrudPortletKeys.ACCIONESCRUD,
		"mvc.command.name=/eliminarLicencia" })

public class EliminarLicenciaMVCRender implements MVCRenderCommand {
	...
	public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
		...
		try {
			...
			System.out.println("Hola, desde EliminarLicenciaMVCRender, esta es la id: " + li.getLicenciasId());
		} catch (NumberFormatException | PortalException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		return "/eliminarLicencia.jsp";
	}
